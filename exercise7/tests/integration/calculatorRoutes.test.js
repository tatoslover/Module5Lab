...
describe('Calculator API Integration Tests', () => {
  ...
  describe('API General Endpoints', () => {
    test('should return welcome message on root endpoint', async () => {
      ...
      expect(response.body.message).toBe("Welcome to Enhanced Calculator API with Libraries!");
      expect(response.body.server).toBe("Exercise 7 - Enhanced Calculator with Libraries");
    ...
    test('should return health check information', async () => {
      ...
      expect(response.body.server).toBe("Exercise 7 - Enhanced Calculator API");

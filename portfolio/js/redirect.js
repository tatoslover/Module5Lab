...
const TARGET_URL = "portfolio/index.html";
...
function cancelRedirect() {
  ...
  if (mainText) {
    mainText.innerHTML =
      'Redirect cancelled. <a href="' +
      TARGET_URL +
      '" class="redirect-link">Click here to continue</a>';
  }
...
function addAccessibilityFeatures() {
  ...
  if (redirectLink) {
    redirectLink.setAttribute(
      "aria-label",
      "Manually navigate to main application",
    );
  }
  ...
  announcement.textContent =
    "Page will redirect to main application in 2 seconds";

// Main JavaScript file for Module 5 Lab Frontend
...
const Exercises = {
    ...
    showExerciseDetails: (exerciseNumber) => {
        const exerciseInfo = {
            ...
            3: "Exercise 3: Calculator Frontend - Interactive HTML frontend that consumes the Calculator API with real-time results.",
        ...
        alert(exerciseInfo[exerciseNumber] || "Exercise information not available.");
    },

    // Show coming soon message
    showComingSoon: () => {
        alert('🚧 This exercise is currently under development!\n\nCheck back soon for the complete implementation.');
    }
};
    ...
    init: () => {
        document.addEventListener('keydown', (e) => {
            ...
            if (e.key >= '1' && e.key <= '8') {
                ...
                const card = document.querySelector(`.exercise-card h3[data-number="${exerciseNumber}"]`);
                if (card) {
...
const App = {
    init: () => {
        console.log('🚀 Module 5 Lab Frontend initialized');
        ...
        document.querySelectorAll('.btn, .test-btn, .operation-btn').forEach(btn => {
